...
2026年9月23日時点で、e-Stat DB/APIを主系、APIにDB表がない統計の
公式Excelを補完系として、2013年・2013年度以降（建設投資見通しは
2008年度以降）を正規化SQLiteへ格納済みです。

- データセット: 14（国交省・日建連13、BuildBase会社別1）
- 統計表: 229表
- 分類の組み合わせ: 17,763,281系列
- 観測セル: 185,512,161件
- 正規化SQLite: 約29GB
- GitHub Pages用の圧縮データ: 約509MB

加えて、BuildBaseで確定したゼネコン21社・54項目・2015～2025年度の
