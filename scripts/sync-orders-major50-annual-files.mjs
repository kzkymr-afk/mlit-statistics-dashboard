...
const SOURCE_BASE =
  ...
  "&result_back=1&tclass1=000001015812&tclass2val=0" +
  "&toukei=00600130&tstat=000001015811";
const PROJECT_ROOT = fileURLToPath(new URL("../", import.meta.url));
const RAW_ROOT = resolve(
  PROJECT_ROOT,
  "data/raw/construction-orders-major-50/annual",
);
...
async function downloadRecord(record) {
  ...
  const signature = bytes.subarray(0, 32).toString("utf8").toLowerCase();
